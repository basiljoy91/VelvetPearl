        ...
        aside={(
          <div className="space-y-4 rounded-3xl border border-white/10 bg-black/20 p-6">
            ...
            <div className="space-y-3 text-sm text-on-surface-variant">
              ...
              <p><span className="font-bold text-white">Email:</span> <a href={SUPPORT_MAILTO}>{SUPPORT_EMAIL}</a></p>
        ...
        <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-3">
          ...
          <article className="rounded-[28px] border border-white/10 bg-black/20 p-8">
            ...
            <p className="mt-4 text-sm text-white">
              Email support: <a className="text-secondary hover:underline" href={SUPPORT_MAILTO}>{SUPPORT_EMAIL}</a>
            </p>
          </article>
        </div>
      </section>
