        ...
        <div className="grid max-w-7xl grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-4 xl:gap-10 mx-auto">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a className="text-sm text-gray-500 hover:text-[#2249DB] transition-all" href={SUPPORT_MAILTO}>{SUPPORT_EMAIL}</a></li>
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mb-4">
              Email: <a className="hover:text-[#2249DB] transition-all" href={SUPPORT_MAILTO}>{SUPPORT_EMAIL}</a>
            </p>
