...
export default function TourBooking() {
  ...
  const validateForm = () => {
    ...
    if (!formData.trip_duration.trim()) nextErrors.trip_duration = 'Trip duration is required.';
          ...
          <form className="space-y-10" noValidate onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <input className={inputClassName(errors, 'trip_duration')} name="trip_duration" onChange={handleChange} placeholder="3 days / 2 nights" type="text" value={formData.trip_duration} />
