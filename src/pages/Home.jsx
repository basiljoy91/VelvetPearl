              ...
              <tbody className="divide-y divide-outline-variant/10">
                <tr className="glass-panel group transition-all duration-300 hover:bg-surface-container-high/60">
                  ...
                  <td className="px-8 py-8 text-right">
                    <button className="bg-primary-container text-white px-8 py-3 font-label text-xs uppercase tracking-widest font-black rounded transition-all duration-300 hover:bg-[#294edf] hover:shadow-[0_0_20px_rgba(34,73,219,0.4)] active:scale-95" onClick={() => navigate('/book/cab', { state: { ...formData, route: 'Chennai → Pondicherry' } })}>Book</button>
                  </td>
                </tr>
                <tr className="glass-panel group transition-all duration-300 hover:bg-surface-container-high/60">
                  <td className="px-8 py-8">
                  ...
                  <td className="px-8 py-8 text-right">
                    <button className="bg-primary-container text-white px-8 py-3 font-label text-xs uppercase tracking-widest font-black rounded transition-all duration-300 hover:bg-[#294edf] hover:shadow-[0_0_20px_rgba(34,73,219,0.4)] active:scale-95" onClick={() => navigate('/book/cab', { state: { ...formData, route: 'Coimbatore → Ooty' } })}>Book</button>
                  </td>
                </tr>
              </tbody>
            </table>
