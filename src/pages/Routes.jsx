...
const POPULAR_ROUTES_NOTICE = 'Route suggestions are temporarily unavailable. You can still search any pickup and drop location above or send a cab enquiry.';
  ...
  useEffect(() => {
    ...
    const loadRoutes = async () => {
      ...
      try {
        ...
        if (!ignore) {
          setPopularRoutes([]);
          setError(POPULAR_ROUTES_NOTICE);
        }
      } finally {
      ...
      <section className="mt-10">
        <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-bold text-white">Frequently Requested Routes</h2>
          </div>
          {routeState.estimate && (
        ...
        <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04]">
            ...
            <table className="min-w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-white/5">
                {isLoading ? (
                  ...
                  <tr>
                    <td className="px-6 py-10 text-center text-gray-300" colSpan="5">Search any pickup and drop location above to begin.</td>
                  </tr>
                )}
              </tbody>
            </table>
          ...
          <div className="grid gap-3 p-3 md:hidden">
            {isLoading ? (
              ...
              <div className="rounded-xl bg-black/20 p-5 text-sm text-gray-400">Search any pickup and drop location above to begin.</div>
            )}
          </div>
        </div>
      </section>
