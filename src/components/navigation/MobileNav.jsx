...
export default function MobileNav({ onBookClick }) {
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-4 pb-6 pt-3 bg-black/80 backdrop-blur-lg border-t border-[#EFBF04]/10 shadow-[0_-10px_30px_rgba(0,0,0,0.5)] md:hidden">
